module Test.Study.Control.Monad.Transformer.StateSpec where

import Prelude

import Data.Maybe (Maybe(..))
import Data.Tuple (Tuple(..))
import Study.Control.Monad.Transformer.State (StateT, evalState, execState, get, gets, modify, put, runState, runStateT, state)
